...
$engine = array(
	'name' => 'umowa_internet_z_telewizja_mini', 	// template directory
	'engine' => 'umowa_internet_z_telewizja_mini', 	// engine.php directory
	...
	'title' => trans('Pakiet: umowa internet z telewizja mini'), 	// description for UI
