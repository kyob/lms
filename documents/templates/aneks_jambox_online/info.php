...
$engine = array(
	'name' => 'aneks_jambox_online', 	// template directory
	'engine' => 'aneks_jambox_online', 	// engine.php directory
				// you can use other engine
	'type' => DOC_ANNEX,			// it's also possible to use array of document types in this field
	'template' => 'template.html', 		// template file (in 'name' dir)
	'title' => trans('Aneks Jambox Online do pakietu Wielotematycznego'), 	// description for UI
