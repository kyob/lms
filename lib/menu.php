...
>>>>>>> 42272d422247b24847376dfe91db6b1cfdb61589
//				array(
//					'name' => trans('Search'),
...
//				),
    ...
    'documentation' => array(
        ...
        'img' => 'doc.gif',
        'fa' => 'fa-medkit',
        'link' => (is_dir('doc' . DIRECTORY_SEPARATOR . 'html' . DIRECTORY_SEPARATOR . $LMS->ui_lang) ? 'doc' . DIRECTORY_SEPARATOR . 'html' . DIRECTORY_SEPARATOR . $LMS->ui_lang . DIRECTORY_SEPARATOR : 'doc' . DIRECTORY_SEPARATOR . 'html' . DIRECTORY_SEPARATOR . 'en' . DIRECTORY_SEPARATOR),
